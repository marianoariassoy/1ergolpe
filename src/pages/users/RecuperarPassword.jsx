...
const index = () => {
  ...
  const onSubmit = async data => {
    setSending(true)
    try {
      const response = await axios.post('https://primergolpe.com.ar/api/users/forgotpassword', data)
      ...
      <div className='flex flex-col gap-y-6'>
        {!sended ? (
          <div className='text-center text-sm px-12'>
            Ingresá tu email, te enviaremos un enlace para restablecer tu contraseña 😉
          </div>
        ) : (
